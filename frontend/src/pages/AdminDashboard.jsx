                  ...
                  <td className="px-8 py-5">
                    <div className="flex flex-col gap-2">
                       <div className="flex justify-between text-[10px] font-bold uppercase">
                          <span className="text-white/40">{event.availableSeats} / {event.totalSeats} Sold</span>
                          <span className="text-white">₹{event.price}</span>
                       </div>
                       <div className="w-32 h-1 bg-white/5 rounded-full overflow-hidden">
                          <div className="h-full bg-white" style={{ width: `${(event.availableSeats / event.totalSeats) * 100}%` }} />
                       </div>
                    </div>
                  </td>
